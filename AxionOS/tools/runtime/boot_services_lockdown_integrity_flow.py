...
AUD=OUT/'boot_services_lockdown_integrity_audit.json'
SMK=OUT/'boot_services_lockdown_integrity_smoke.json'
EX={"BOOT_SERVICES_EXIT_HOOK_DETECTED":1965,"RUNTIME_SERVICES_POINTER_TAMPER_ACCEPTED":1966}
...
def main():
 ...
 if m=='fail1': checks['PASS_POLICY_ENFORCED']=False; failures=[{'code':'BOOT_SERVICES_EXIT_HOOK_DETECTED','detail':'negative control 1'}]
 elif m=='fail2': checks['PASS_RULESET_CONSISTENT']=False; failures=[{'code':'RUNTIME_SERVICES_POINTER_TAMPER_ACCEPTED','detail':'negative control 2'}]
