...
AUD=OUT/'firmware_update_transport_integrity_audit.json'
SMK=OUT/'firmware_update_transport_integrity_smoke.json'
EX={"FW_UPDATE_CHANNEL_AUTH_BYPASS":1957,"FW_UPDATE_REPLAY_ACCEPTED":1958}
...
def main():
 ...
 if m=='fail1': checks['PASS_POLICY_ENFORCED']=False; failures=[{'code':'FW_UPDATE_CHANNEL_AUTH_BYPASS','detail':'negative control 1'}]
 elif m=='fail2': checks['PASS_RULESET_CONSISTENT']=False; failures=[{'code':'FW_UPDATE_REPLAY_ACCEPTED','detail':'negative control 2'}]
