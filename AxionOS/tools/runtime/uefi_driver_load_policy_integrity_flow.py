...
AUD=OUT/'uefi_driver_load_policy_integrity_audit.json'
SMK=OUT/'uefi_driver_load_policy_integrity_smoke.json'
EX={"UEFI_DRIVER_ALLOWLIST_BYPASS":1953,"UEFI_OPTION_ROM_EXECUTION_UNCHECKED":1954}
...
def main():
 ...
 if m=='fail1': checks['PASS_POLICY_ENFORCED']=False; failures=[{'code':'UEFI_DRIVER_ALLOWLIST_BYPASS','detail':'negative control 1'}]
 elif m=='fail2': checks['PASS_RULESET_CONSISTENT']=False; failures=[{'code':'UEFI_OPTION_ROM_EXECUTION_UNCHECKED','detail':'negative control 2'}]
