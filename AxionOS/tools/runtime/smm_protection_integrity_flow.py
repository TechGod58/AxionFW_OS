...
AUD=OUT/'smm_protection_integrity_audit.json'
SMK=OUT/'smm_protection_integrity_smoke.json'
EX={"SMM_LOCKDOWN_BYPASS_DETECTED":1963,"SMRAM_ACCESS_VIOLATION_UNCHECKED":1964}
...
def main():
 ...
 if m=='fail1': checks['PASS_POLICY_ENFORCED']=False; failures=[{'code':'SMM_LOCKDOWN_BYPASS_DETECTED','detail':'negative control 1'}]
 elif m=='fail2': checks['PASS_RULESET_CONSISTENT']=False; failures=[{'code':'SMRAM_ACCESS_VIOLATION_UNCHECKED','detail':'negative control 2'}]
