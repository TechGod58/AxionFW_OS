...
AUD=OUT/'tpm_nv_index_policy_integrity_audit.json'
SMK=OUT/'tpm_nv_index_policy_integrity_smoke.json'
EX={"TPM_NV_POLICY_WRITE_BYPASS":1955,"TPM_NV_INDEX_ATTR_MISMATCH_ACCEPTED":1956}
...
def main():
 ...
 if m=='fail1': checks['PASS_POLICY_ENFORCED']=False; failures=[{'code':'TPM_NV_POLICY_WRITE_BYPASS','detail':'negative control 1'}]
 elif m=='fail2': checks['PASS_RULESET_CONSISTENT']=False; failures=[{'code':'TPM_NV_INDEX_ATTR_MISMATCH_ACCEPTED','detail':'negative control 2'}]
