...
AUD=OUT/'firmware_capsule_update_integrity_audit.json'
SMK=OUT/'firmware_capsule_update_integrity_smoke.json'
EX={"CAPSULE_SIGNATURE_VERIFICATION_BYPASS":1943,"CAPSULE_PAYLOAD_TAMPER_ACCEPTED":1944}
...
def main():
 ...
 if m=='fail1': checks['PASS_POLICY_ENFORCED']=False; failures=[{'code':'CAPSULE_SIGNATURE_VERIFICATION_BYPASS','detail':'negative control 1'}]
 elif m=='fail2': checks['PASS_RULESET_CONSISTENT']=False; failures=[{'code':'CAPSULE_PAYLOAD_TAMPER_ACCEPTED','detail':'negative control 2'}]
