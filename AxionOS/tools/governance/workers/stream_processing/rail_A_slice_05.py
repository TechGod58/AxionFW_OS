...
WORKER_ID = "rail_A_slice_05"
STEP_NAME = "slice_producer_idempotence_window"
...
COMMANDS = [
    [sys.executable, axion_path_str('tools', 'runtime', 'producer_idempotence_window_integrity_flow.py')]
]
