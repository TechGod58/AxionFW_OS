...
WORKER_ID = "rail_C_emit_05"
STEP_NAME = "emit_final_integrity_checkpoint"
...
COMMANDS = [
    [sys.executable, axion_path_str('tools', 'governance', 'emit_governance_baseline_drift.py')],
    [sys.executable, axion_path_str('tools', 'governance', 'emit_integrity_system_health.py')],
    [sys.executable, axion_path_str('tools', 'governance', 'emit_axionos_integrity_status.py')],
]
