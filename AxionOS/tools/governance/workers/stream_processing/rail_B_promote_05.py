...
WORKER_ID = "rail_B_promote_05"
STEP_NAME = "promote_hotkey_action_registry_integrity"
...
COMMANDS = [
    [sys.executable, axion_path_str('tools', 'governance', 'workers', 'stream_processing', 'write_rail_b_plan.py'), r"hotkey_action_registry_integrity", r"2041"],
