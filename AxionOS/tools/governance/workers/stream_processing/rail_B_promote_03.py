...
WORKER_ID = "rail_B_promote_03"
STEP_NAME = "promote_consumer_group_balance_integrity"
...
COMMANDS = [
    [sys.executable, axion_path_str('tools', 'governance', 'workers', 'stream_processing', 'write_rail_b_plan.py'), r"consumer_group_balance_integrity", r"2021"],
    [sys.executable, axion_path_str('tools', 'governance', 'rail_b_worker.py')],
]
