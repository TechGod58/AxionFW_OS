...
WORKER_ID = "rail_B_promote_04"
STEP_NAME = "promote_hotkey_layout_integrity"
...
COMMANDS = [
    [sys.executable, axion_path_str('tools', 'governance', 'workers', 'stream_processing', 'write_rail_b_plan.py'), r"hotkey_layout_integrity", r"2031"],
