...
WORKER_ID = "rail_B_promote_01"
STEP_NAME = "promote_event_schema_integrity"
...
COMMANDS = [
    [sys.executable, axion_path_str('tools', 'governance', 'workers', 'stream_processing', 'write_rail_b_plan.py'), r"event_schema_integrity", r"2001"],
